          ...
          <div>
            ...
            <div className="flex items-center gap-4">
              <a
                ...
                className="text-white/70 hover:text-bronze transition-colors duration-200 cursor-pointer"
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className={`font-dm text-xs uppercase tracking-widest transition-colors ${
                locale === "fr" ? "text-bronze" : "text-white/40 hover:text-white"
              }`}
            >
              FR
            </Link>
            ...
            <Link
              href={`/en`}
              className={`font-dm text-xs uppercase tracking-widest transition-colors ${
                locale === "en" ? "text-bronze" : "text-white/40 hover:text-white"
              }`}
            >
              EN
            </Link>
